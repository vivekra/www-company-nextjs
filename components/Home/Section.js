        ...
        <div className="container">
            ...
            <div className="grid-wrapper">
                <div className="row justify-content-center">
                    ...
                    <div className="col-xl-4 col-lg-6">
                        <Link href="application-management.php" className="service-block text-center">
                    ...
                    <div className="col-xl-4 col-lg-6">
                        <Link href="internet-marketing.php" className="service-block text-center">
                    ...
                    <div className="col-xl-4 col-lg-6">
                        <Link href="security-audit.php" className="service-block text-center">
