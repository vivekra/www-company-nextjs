...
function section() {
  return (
    <div>
         <section className="sec" id="cynic-services" data-scroll-offset="165">
        
            <div className="container">
                <h2 >Services We Provide</h2>
                <p className="txt">DigitalQ provides IT professional services, Software development to Digital Marketing.</p>
...
<div className="content">
    <a href="application-management.php" className="service-block text-center">
        <img src="assets/images/services/service-icon-2.png" alt="undefined"/>
...
<div className="content">
    <a href="application-management.php" className="service-block text-center">
        <img src="assets/images/services/service-icon-3.png" alt="undefined"/>
        ...
        <p>DigitalQ helps you to capitalize the opportunities in the mobile Internet space. We design end-to-end m-commerce solutions that facilitate you to exploit the full potential of the emerging wireless communication technologies</p>
                   ...
                   <div className="row-2">
<div className="content">
    <a href="internet-marketing.php" className="service-block text-center">
        <img src="assets/images/services/service-icon-4.png" alt="Search Engine Optimization"/>
...
<div className="content">
    <a href="security-audit.php" className="service-block text-center">
        <img src="assets/images/services/service-icon-5.png" alt="Pay-Per-Click"/>
...
<div className="content">
    <a href="internet-marketing.php" className="service-block text-center">
        <img src="assets/images/services/service-icon-6.png" alt="Social Media Marketing"/>
